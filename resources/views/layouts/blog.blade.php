                ...
                <div class="col-lg-8">
                    <div class="blog_left_sidebar">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{asset('clients/img/blog/main-blog/m-blog-2.jpg')}}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{asset('clients/img/blog/main-blog/m-blog-3.jpg')}}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{asset('clients/img/blog/main-blog/m-blog-4.jpg')}}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
                                            <h2>The Night Sky</h2>
                                        </a>
                        ...
                        <article class="row blog_item">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    <img src="{{asset('clients/img/blog/main-blog/m-blog-5.jpg')}}" alt="">
                                    <div class="blog_details">
                                        <a href="single-blog.html">
