            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget mail-chimp">
                    ...
                    <ul class="instafeed d-flex flex-wrap">
                        <li><img src="{{asset('clients/img/i1.jpg')}}" alt=""></li>
                        <li><img src="{{asset('clients/img/i2.jpg')}}" alt=""></li>
                        <li><img src="{{asset('clients/img/i3.jpg')}}" alt=""></li>
                        <li><img src="{{asset('clients/img/i4.jpg')}}" alt=""></li>
                        <li><img src="{{asset('clients/img/i5.jpg')}}" alt=""></li>
                        <li><img src="{{asset('clients/img/i6.jpg')}}" alt=""></li>
                        <li><img src="{{asset('clients/img/i7.jpg')}}" alt=""></li>
                        <li><img src="{{asset('clients/img/i8.jpg')}}" alt=""></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-6">
