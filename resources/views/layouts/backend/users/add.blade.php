                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <input type="password" name="confirm_password" class="form-control" value="{{ old('confirm_password') }}" placeholder="Nhập lại mật khẩu...">
                        ...
                        <div class="col-6">
                            ...
                            <select name="role" id="" class="form-control">
                                <option value="0" {{ old('role')==0?'selected':false }}>Người dùng</option>
                                <option value="1" {{ old('role')==1?'selected':false }}>Quản trị viên</option>
                            </select>
                            @error('description')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
