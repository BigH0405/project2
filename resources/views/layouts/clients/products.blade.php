        ...
        <div class="col-xl-9 col-lg-8 col-md-7">
            ...
            <div class="filter-bar d-flex flex-wrap align-items-center">
                ...
                <form action="" method="GET">
                    <div class="row mt-3">
                        <div class="col-8">
                            <input ytype="search" name="keywords" id="" class="form-control mb-3"
                                placeholder="Nhập từ khóa tìm kiếm..." value="{{ request()->keywords }}">
                        </div>
                        <div class="col-3">
                        ...
                        <div class="quick-view-content">
                            ...
                            <div class="middle">
                                <p class="content">Mill Oil is an innovative oil filled radiator with the most modern
                                    ...
                                    awesome, and at the same time give you the pleasant warm feeling during the winter.
                                </p>
